...
$consulta = "SELECT ID_Cliente, Nome, Telefone, Email, Endereco FROM Clientes";
/* 
...
<body>
    ...
    <div class="content2">
		<section>
			...
			<p><a href="homepage.php" ><i class="fa fa-home" aria-hidden="true"></a></i> Home <i class="fa fa-arrow-right" aria-hidden="true"></i> Clientes</p>
			</div>
		</section>
	</div>
        ...
        <a href='cadastro-clientes.php'><button class="botao-cadastro"><i class="fa fa-plus" aria-hidden="true"></i> Cadastrar</button></a>  
                <div class="card">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                            <a href="editar-formulario-clientes.php?ID_Cliente=<?php echo $dado['ID_Cliente']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <a href="excluir-cliente.php?ID_Cliente=<?php echo $dado['ID_Cliente']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
