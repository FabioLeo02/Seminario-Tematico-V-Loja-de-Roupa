...
$consulta = "SELECT ID_Funcionario ,Nome , Telefone , Email , Endereco FROM Funcionarios";
/* 
...
<body>
    ...
    <div class="content2">
		<section>
			...
			<p><a href="homepage.php" ><i class="fa fa-home" aria-hidden="true"></a></i> Home <i class="fa fa-arrow-right" aria-hidden="true"></i> Funcionarios</p>
			</div>
		</section>
	</div>
    ...
    <div class="content">
		<section>
		<div class="container">
        <a href='cadastro-funcionarios.php'><button class="botao-cadastro"><i class="fa fa-plus" aria-hidden="true"></i> Cadastrar</button></a>  
                <div class="card">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <th>Email</th>
                            <th><div class="endereco">Endereço</div></th> 
                        </tr>
                        <?php while($dado = $con->fetch_array()) { ?> 
                        <tr>
                            <td>
                            <a href="editar-formulario-funcionarios.php?ID_Funcionario=<?php echo $dado['ID_Funcionario']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <a href="excluir-funcionario.php?ID_Funcionario=<?php echo $dado['ID_Funcionario']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                            <td><?php echo $dado["Nome"]; ?></td>
                            <td><?php echo $dado["Telefone"]; ?></td>
                            <td class="telefone"><?php echo $dado["Email"]; ?></td>
