...
<body>
    ...
    <div class="content2">
		<section>
			...
			<p><a href="homepage.php" ><i class="fa fa-home" aria-hidden="true"></a></i> Home <i class="fa fa-arrow-right" aria-hidden="true"></i> Fornecedores</p>
			</div>
		</section>
	</div>
    ...
    <div class="content">
		<section>
		<div class="container">
            <a href='cadastro-fornecedores.php'><button class="botao-cadastro"><i class="fa fa-plus" aria-hidden="true"></i> Cadastrar</button></a>  
                <div class="card">
